...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" shadow-lg text-[18px] fixed w-full top-0 left-0 right-0 z-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              <NavLink to="/" className="text-2xl font-bold flex items-center space-x-2">
                <BsBag />
                <span className="px-2">E-shopping</span>
              </NavLink>
            </div>
            ...
            <div className="hidden md:flex space-x-4">
              ...
              <button  className="btn btn-outline-dark flex items-center space-x-2">
